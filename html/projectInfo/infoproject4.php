...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic5.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                    ...
                    <br />
                    <p>
                        The bar graph is similar to the light dimmer. The difference is that it consists of multiple LEDs and using the potentiometer, we turn the LEDs on or off in a series depending on which way we tweak. It is fun to play around with.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
