...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic7.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                        <u><h1>Audio visualizer</h1></u>
                    <p class="h3">
                        Description
                    </p>
                    <br />
                    <p>
                        For this project, I used a sound sensor to detect noise around and depending on how much noise was detected by it, the LEDs turned on respectively from green to red to illustrate its intensity.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
