...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic4.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                        <u><h1>Light dimmer</h1></u>
                    <p class="h3">
                        Description
                    </p>
                    <br />
                    <p>
                        This arduino based project consists of an LED and a potentiometer. The purpose of this potentiometer is to tweak the brightness of the LED. Tweaking it to the left reduces brightness and to the right increases it.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
