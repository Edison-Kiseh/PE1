...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic1.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                    <u><h1>The sound sensor</h1></u>
                    ...
                    <br />
                    <p>
                        This is made using arduino uno. The microphone itself was ordered online and I managed to implement it to my arduino and use the data/sound it reads from around to then diplay it using some other components like LEDs.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
                        ...
                        echo("<form method=\"POST\" action=\"test.php?item=".$num."\" onsubmit=\"return verify()\"> ");
                            ...
                            echo("<p>
                                    <input type=\"submit\" value=\"Add to cart\" id=\"button\"></input> 
                                </p>");
                        echo("</form>");
                    ?> 
                </div>
