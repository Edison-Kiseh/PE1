...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic6.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                        <u><h1>Running lights</h1></u>
                    <p class="h3">
                        Description
                    </p>
                    <br />
                    <p>
                        This is project consists of a series of LEDs on a breadboard and when active, the lights run one at a time in a series from left to right and vice versa.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
