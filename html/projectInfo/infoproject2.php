...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic3.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                    ...
                    <br />
                    <p>
                        This is another arduino based project. It is basically a robot arm that is able to move around thanks to the servos which have been installed on it (4 in this case). For each of these servos, three pins are needed: one for 5v, another for ground and the other is the pin for controlling the servo.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
