...
<body>
    <div class="background">
        ...
        <div class="container" >
            <div class="row">
            <div class="col-3">
                    <img src="../../images/pic2.jpg" alt="project" class="project" style="height: 240px"/>
                </div>
                <div class="col-sm-6" style="padding: 0px 30px 0px 30px;">
                        <u><h1>Analog dial</h1></u>
                    <p class="h3">
                        Description
                    </p>
                    <br />
                    <p>
                        Today, visual representations of measurements are usually displayed digitally on an LCD screen or with LED digits, but not that long ago, analog dials were always used to show pressure, speed and even time! The Arduino can detect voltage input from a sensor and I have used that capability here to create a dial that the arduino moves in responsed to the input received by the sensor. For this dial, I have used a photoresistor to measeure light input.
                    </p>
                </div>
                <div class="col-sm-3">
                    <?php 
